...
| 4. $\delta [n-m]$   | $z^{-m}$ | All $z$ except $0 & \mbox{if } m>0$ or $\infty & \mbox{if } m<0$ |
...
|13. $a^n, & 0\le n\le N-1  0, & \mbox{ otherwise} \end{matrix}$ | $1-a^Nz^{-N}\over{1-az^{-1}}$ | $\| z\| >0$ |
|\begin{Bmatrix} x & y \\ z & v \end{Bmatrix}	|\begin{Bmatrix} x & y \\ z & v \end{Bmatrix}	|\begin{Bmatrix} x & y \\ z & v \end{Bmatrix}	|
